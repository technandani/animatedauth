                    ...
                    >
                        ...
                        <div className="flex flex-col items-center text-center max-w-lg">
                            <div className="mb-8 relative">
                                     {!isLogin ? (
                                    <img
                                        src="https://res.cloudinary.com/dmyq2ymj9/image/upload/v1756718304/output-onlinepngtools_nptfvm.png"
                                        alt="Signup Logo"
                                        className="w-[500px] h-auto object-contain"
                                    />
                                ) : (
                                    <img
                                        src="https://res.cloudinary.com/dmyq2ymj9/image/upload/v1756717798/Help-Desk-PNG-Picture_ftycge.png"
                                        alt="Login Logo"
                                        className="w-[500px] h-auto object-contain"
                                    />
                                )}
